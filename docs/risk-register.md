...
| MQ reliability | Local message retry and consumer idempotency logs | RocketMQ outage can delay async order/event delivery until retry succeeds | Add dead-letter handling docs and retry dashboard |
