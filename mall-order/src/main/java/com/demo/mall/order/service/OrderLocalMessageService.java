...
public class OrderLocalMessageService {
    ...
    public boolean saveAndSend(String messageKey,
                               ...
                               String tag,
                               Object payload) {
        OrderLocalMessage message = savePending(messageKey, bindingName, topic, tag, payload);
        return send(message, payload);
    }

    public OrderLocalMessage savePending(String messageKey,
                                         String bindingName,
                                         String topic,
                                         String tag,
                                         Object payload) {
    ...
    private boolean send(OrderLocalMessage message, Object payload) {
        boolean sent = false;
        try {
